...
libsources :=  	$(SRC)/io.c \
				...
				$(SRC)/dictionary/staticarray/sahandler.c \
				$(SRC)/dictionary/staticarray/staticarray.c
...
tlsources   := 	$(SRC)/tests/CuTest.c  \
				...
				#$(SRC)/tests/unit/dictionary/staticarray/sahandler.c
...
testsources := 	$(SRC)/test.c	\
				$(SRC)/tests/unit/dictionary/staticarray/run_staticarray.c
