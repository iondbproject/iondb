...
void ffdict_init(dictionary_handler_t *handler)
{
...
err_t ffdict_insert(dictionary_t *dictionary, ion_key_t key, ion_value_t value)
{
	return ff_insert((ff_file_t *)dictionary->instance, key, value);
}

/** @todo the value needs to be fixed */
err_t ffdict_query(dictionary_t *dictionary, ion_key_t key, ion_value_t value)
{
...
err_t ffdict_delete_dictionary(dictionary_t *dictionary)
{
...
err_t ffdict_update(dictionary_t *dictionary, ion_key_t key, ion_value_t value)
{
...
cursor_status_t ffdict_next(dict_cursor_t *cursor, ion_record_t *record)
{
