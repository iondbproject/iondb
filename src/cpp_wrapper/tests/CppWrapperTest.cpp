...
/* #include "../BppTree.h" //Test1: works, Test2: works */
/* #include "../FlatFile.h" //Test1: error->query #1, Test2: error->query #1 */
#include "../LinearHash.h"	/* Test1: crashes->error code 11, Test2: error->query #1 */
/* #include "../OpenAddressFileHash.h" //Test1: infinite loop->query #1, Test2: redefinition error */
/* #include "../OpenAddressHash.h" //Test1: infinite loop->query #1, Test2: error->query #1 */
/* #include "../SkipList.h" //Test1: error code 11->query #2, Test2: error->query #2 */
...
main(
	...
	Dictionary<int> *btree = new LinearHash<int>(key_type_numeric_signed, sizeof(int), 10, 900);
...
/*	char*			returned_key			= ((char*) record.key); */
