...
void setup()
{
    ...
    Dictionary<int> *oah = new OpenAddressHash<int>(key_type_numeric_signed, sizeof(int), 10, 20);
    ...
    string returned_value = oah->get<string>(key_1);
    ...
    returned_value = oah->get<string>(key_1);
    ...
    Serial.println("End OpenAddressHash (int key) test.");
