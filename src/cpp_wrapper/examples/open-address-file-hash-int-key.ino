...
void setup()
{
    ...
    Dictionary<int> *oafh = new OpenAddressFileHash<int>(key_type_numeric_signed, sizeof(int), 10, 20);
    ...
    string returned_value = oafh->get<string>(key_1);
    ...
    returned_value = oafh->get<string>(key_1);
    ...
    Serial.println("End OpenAddressFileHash (int key) test.");
