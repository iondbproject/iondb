...
void setup()
{
    ...
    Dictionary<string> *lh = new LinearHash<string>(key_type_char_array, sizeof(int), 10, 20);
    ...
    int returned_value = lh->get<int>(key_1);
    ...
    returned_value = lh->get<int>(key_1);
    ...
    Serial.println("End LinearHash (string key) test.");
