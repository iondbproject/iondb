...
void setup()
{
    ...
    Dictionary<int> *ff = new FlatFile<int>(key_type_numeric_signed, sizeof(int), 10, 20);

    /* Insert into flat file dictionary */
    ...
    string returned_value = ff->get<string>(key_1);
    ...
    returned_value = ff->get<string>(key_1);
    ...
    Serial.println("End FlatFile (int key) test.");
