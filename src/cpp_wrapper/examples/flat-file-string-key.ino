...
void setup()
{
    ...
    /* We make this call because FlatFile dictionary structure is file-based */
    SD.begin();

    Serial.println("Set-up complete.");

    /* Create Flat File dictionary instance: key type, key size, value size, dictionary size */
    Dictionary<string> *ff = new FlatFile<string>(key_type_char_array, sizeof(int), 10, 20);

    /* Insert into flat file */
    Serial.println("Insert key_1 [1]");
    string key_1 = "key_1";
    int value = 1;
    ff->insert(key_1, value);

    /* Return the value inserted into the flat file */
    int returned_value = ff->get<int>(key_1);
    ...
    /* Update value */
    int new_value = 2;
    ff->update(key_1, new_value);

    /* Verify update was successful */
    returned_value = ff->get<int>(key_1);
    ...
    Serial.println("End FlatFile (string key) test.");
