...
iinq_field_t getFieldType(iinq_table_id table, iinq_field_num_t field_num) {
...
ion_err_t execute(iinq_prepared_sql *p) {
	switch (p->table) {
		case 0: {
...
iinq_prepared_sql *iinq_insert_3(int value_1, int value_2, char *value_3) {
	iinq_prepared_sql *p = malloc(sizeof(iinq_prepared_sql));
	p->table = 3;
	p->value = malloc((sizeof(int) * 2)+(sizeof(char) * 6));
	unsigned char	*data = p->value;
...
iinq_prepared_sql *iinq_insert_0(int value_1, char *value_2, char *value_3, int value_4, char *value_5) {
	iinq_prepared_sql *p = malloc(sizeof(iinq_prepared_sql));
	p->table = 0;
...
iinq_prepared_sql *iinq_insert_1(char *value_1, char *value_2, char *value_3, int value_4, char *value_5) {
	iinq_prepared_sql *p = malloc(sizeof(iinq_prepared_sql));
	p->table = 1;
