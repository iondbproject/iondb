...
@brief		Unit cpp_wrapper for Skiplist data store
*/
/******************************************************************************/
...
/**
@brief	  Tests a deletion of a skiplist with one element, and then cpp_wrapper a
...
/**
@brief	  Tests a deletion of a skiplist with several elements, and then cpp_wrapper
