...
iinq_test_the_ultimate_query(
	...
	test_val_1.a	= 42;
	test_val_1.b	= 2108;
	iinq_test_insert(tc, IONIZE(1, int32_t), &test_val_1);

	test_val_1.a	= 42;
	test_val_1.b	= 32;
	iinq_test_insert(tc, IONIZE(2, int32_t), &test_val_1);

	test_val_1.a	= 18;
	test_val_1.b	= 601;
	iinq_test_insert(tc, IONIZE(3, int32_t), &test_val_1);

	test_val_1.a	= 13;
	test_val_1.b	= 601;
	iinq_test_insert(tc, IONIZE(4, int32_t), &test_val_1);

	test_val_1.a	= 1;
	test_val_1.b	= 601;
	iinq_test_insert(tc, IONIZE(5, int32_t), &test_val_1);

	test_val_1.a	= 9;
	test_val_1.b	= 11;
	iinq_test_insert(tc, IONIZE(6, int32_t), &test_val_1);

	test_val_2.c	= 17;
	test_val_2.d	= -66;
	iinq_test_insert(tc, "cat", &test_val_2);

	test_val_2.c	= 42;
	test_val_2.d	= 44;
	iinq_test_insert(tc, "dog", &test_val_2);

	test_val_2.c	= 18;
	test_val_2.d	= 128;
	iinq_test_insert(tc, "frog", &test_val_2);
	...
	test_val_2.c	= 1;
	test_val_2.d	= 713;
	iinq_test_insert(tc, "cow", &test_val_2);
