...
iinq_test_create_query_select_all_from_where_orderby_ascending_records(
	...
	printf("Count: %d\nKey: %d\nValue: %d\n", count, NEUTRALIZE(key, uint32_t), NEUTRALIZE(value, uint32_t));
...
iinq_benchmark_query_7(
	 ...
	 * ORDER BY test_1->attr1 DESC
	 * */

	MATERIALIZED_QUERY(SELECT(SELECT_GRBY(0), SELECT_AGGR(0)), AGGREGATES(MAX(test_2_tuple->attr0), COUNT(test_1_tuple->attr1)), FROM(1, test_1, test_2), WHERE(test_1_tuple->attr3 >= test_2_tuple->attr1), GROUPBY(ASCENDING_UINT(test_2_tuple->attr0)), HAVING((int16_t) AGGREGATE(0) % 2 == 0), ORDERBY(DESCENDING_UINT(test_1_tuple->attr1)), , , processor);
}
...
void
iinq_test_create_query_select_max_from_where_orderby_records(
	planck_unit_test_t	*tc,
	ion_iinq_result_t	*result,
	uint32_t			count,
	uint32_t			total
	...
	int		expected_key	= total - 1;
	double	maxval			= NEUTRALIZE(result->processed, double);

	PLANCK_UNIT_ASSERT_TRUE(tc, expected_key == maxval);
}

void
iinq_test_create_query_select_min_from_where_orderby_records(
	planck_unit_test_t	*tc,
	ion_iinq_result_t	*result,
	uint32_t			count,
	uint32_t			total
...
iinq_test_select_max_from_where_orderby_ascending(
	...
	MATERIALIZED_QUERY(SELECT(SELECT_AGGR(0)), AGGREGATES(MAX(NEUTRALIZE(test.key, uint32_t))), FROM(0, test), WHERE(1), GROUPBY_NONE, HAVING_NONE, ORDERBY(ASCENDING_INT(AGGREGATE(0))), , , processor);
}
...
iinq_test_select_max_from_where_orderby_descending(
	...
	MATERIALIZED_QUERY(SELECT(SELECT_AGGR(0)), AGGREGATES(MAX(NEUTRALIZE(test.key, uint32_t))), FROM(0, test), WHERE(1), GROUPBY_NONE, HAVING_NONE, ORDERBY(DESCENDING_INT(AGGREGATE(0))), , , processor);
}

void
iinq_test_select_min_from_where_orderby_ascending(
	ion_iinq_query_processor_t *processor
) {
	MATERIALIZED_QUERY(SELECT(SELECT_AGGR(0)), AGGREGATES(MIN(NEUTRALIZE(test.key, uint32_t))), FROM(0, test), WHERE(1), GROUPBY_NONE, HAVING_NONE, ORDERBY(ASCENDING_INT(AGGREGATE(0))), , , processor);
}

void
iinq_test_select_min_from_where_orderby_descending(
	ion_iinq_query_processor_t *processor
) {
	MATERIALIZED_QUERY(SELECT(SELECT_AGGR(0)), AGGREGATES(MIN(NEUTRALIZE(test.key, uint32_t))), FROM(0, test), WHERE(1), GROUPBY_NONE, HAVING_NONE, ORDERBY(DESCENDING_INT(AGGREGATE(0))), , , processor);
}

void
iinq_test_create_query_select_max_from_where_orderby(
	planck_unit_test_t	*tc,
	uint32_t			num_records,
	ion_boolean_e		ascending
) {
	...
	state.func	= iinq_test_create_query_select_max_from_where_orderby_records;
...
void
iinq_test_create_query_select_min_from_where_orderby(
	planck_unit_test_t	*tc,
	uint32_t			num_records,
	ion_boolean_e		ascending
) {
	...
	state.func	= iinq_test_create_query_select_min_from_where_orderby_records;
	...
	if (boolean_true == ascending) {
		iinq_test_select_min_from_where_orderby_ascending(&processor);
	}
	else {
		iinq_test_select_min_from_where_orderby_descending(&processor);
	}
...
void
iinq_test_create_query_select_max_from_where_orderby_ascending_small(
	planck_unit_test_t *tc
) {
	iinq_test_create_query_select_max_from_where_orderby(tc, 2, boolean_true);
}

void
iinq_test_create_query_select_max_from_where_orderby_ascending_large(
	planck_unit_test_t *tc
) {
	iinq_test_create_query_select_max_from_where_orderby(tc, 100, boolean_true);
}

void
iinq_test_create_query_select_max_from_where_orderby_descending_small(
	planck_unit_test_t *tc
) {
	iinq_test_create_query_select_max_from_where_orderby(tc, 2, boolean_false);
}

void
iinq_test_create_query_select_max_from_where_orderby_descending_large(
	planck_unit_test_t *tc
) {
	iinq_test_create_query_select_max_from_where_orderby(tc, 100, boolean_false);
}

void
iinq_test_create_query_select_min_from_where_orderby_ascending_small(
	planck_unit_test_t *tc
) {
	iinq_test_create_query_select_min_from_where_orderby(tc, 2, boolean_true);
}

void
iinq_test_create_query_select_min_from_where_orderby_ascending_large(
	planck_unit_test_t *tc
) {
	iinq_test_create_query_select_min_from_where_orderby(tc, 100, boolean_true);
}

void
iinq_test_create_query_select_min_from_where_orderby_descending_small(
	planck_unit_test_t *tc
) {
	iinq_test_create_query_select_min_from_where_orderby(tc, 2, boolean_false);
}

void
iinq_test_create_query_select_min_from_where_orderby_descending_large(
	planck_unit_test_t *tc
) {
	iinq_test_create_query_select_min_from_where_orderby(tc, 100, boolean_false);
}

void
iinq_test_create_query_select_count_from_where_groupby_orderby_ascending_aggregate_schema(
	planck_unit_test_t *tc
) {
	DEFINE_SCHEMA(test, {
		int x;
	...
	MATERIALIZED_QUERY(SELECT(SELECT_AGGR(0), SELECT_AGGR(1)), AGGREGATES(MIN(test_tuple->x), MAX(test_tuple->y)), FROM(1, test), WHERE(1), GROUPBY(ASCENDING_INT(NEUTRALIZE(test.key, uint32_t))), HAVING_ALL, ORDERBY(ASCENDING_INT(NEUTRALIZE(test.key, uint32_t))), , , &processor);
...
void
iinq_test_create_query_select_count_max_from_where_schema_records(
	planck_unit_test_t	*tc,
	ion_iinq_result_t	*result,
	uint32_t			count,
	uint32_t			total
...
void
iinq_test_create_query_select_count_max_from_where_groupby_orderby_aggregate_ascending_schema(
	planck_unit_test_t *tc
) {
	DEFINE_SCHEMA(test, {
		int x;
	...
	state.tc	= tc;
	state.total = 2;
	state.func	= iinq_test_create_query_select_count_max_from_where_schema_records;
	...
	MATERIALIZED_QUERY(SELECT(SELECT_AGGR(0), SELECT_AGGR(1)), AGGREGATES(COUNT(test_tuple->x), MAX(test_tuple->y)), FROM(1, test), WHERE(1), GROUPBY(ASCENDING_INT(NEUTRALIZE(test.key, uint32_t))), HAVING_ALL, ORDERBY(ASCENDING_INT(NEUTRALIZE(test.key, uint32_t))), , , &processor);
...
void
iinq_test_create_query_select_count_max_from_where_groupby_orderby_aggregate_descending_schema(
	planck_unit_test_t *tc
) {
	DEFINE_SCHEMA(test, {
		int x;
	...
	MATERIALIZED_QUERY(SELECT(SELECT_AGGR(0), SELECT_AGGR(1)), AGGREGATES(COUNT(test_tuple->x), MAX(test_tuple->y)), FROM(1, test), WHERE(1), GROUPBY(DESCENDING_INT(NEUTRALIZE(test.key, uint32_t))), HAVING_ALL, ORDERBY(ASCENDING_INT(NEUTRALIZE(test.key, uint32_t))), , , &processor);
...
void
iinq_test_create_query_select_count_max_from_where_groupby_aggregate_schema(
	planck_unit_test_t *tc
) {
	DEFINE_SCHEMA(test, {
		int x;
	...
	MATERIALIZED_QUERY(SELECT(SELECT_AGGR(0), SELECT_AGGR(1)), AGGREGATES(COUNT(test_tuple->x), MAX(test_tuple->y)), FROM(1, test), WHERE(1), GROUPBY(ASCENDING_INT(NEUTRALIZE(test.key, uint32_t))), HAVING_ALL, ORDERBY_NONE, , , &processor);
...
void
iinq_test_create_query_select_count_min_from_where_schema_records(
	planck_unit_test_t	*tc,
	ion_iinq_result_t	*result,
	uint32_t			count,
	uint32_t			total
	...
	double minval = *((double *) (result->processed) + 1);
...
void
iinq_test_create_query_select_count_min_from_where_groupby_orderby_aggregate_ascending_schema(
	planck_unit_test_t *tc
) {
	DEFINE_SCHEMA(test, {
		int x;
	...
	state.tc	= tc;
	state.total = 2;
	state.func	= iinq_test_create_query_select_count_min_from_where_schema_records;
	...
	MATERIALIZED_QUERY(SELECT(SELECT_AGGR(0), SELECT_AGGR(1)), AGGREGATES(COUNT(test_tuple->y), MIN(test_tuple->x)), FROM(1, test), WHERE(1), GROUPBY(ASCENDING_INT(NEUTRALIZE(test.key, uint32_t))), HAVING_ALL, ORDERBY(ASCENDING_INT(NEUTRALIZE(test.key, uint32_t))), , , &processor);
...
void
iinq_test_create_query_select_count_min_from_where_groupby_orderby_aggregate_descending_schema(
	planck_unit_test_t *tc
) {
	DEFINE_SCHEMA(test, {
		int x;
	...
	MATERIALIZED_QUERY(SELECT(SELECT_AGGR(0), SELECT_AGGR(1)), AGGREGATES(COUNT(test_tuple->y), MIN(test_tuple->x)), FROM(1, test), WHERE(1), GROUPBY(ASCENDING_INT(NEUTRALIZE(test.key, uint32_t))), HAVING_ALL, ORDERBY(DESCENDING_INT(NEUTRALIZE(test.key, uint32_t))), , , &processor);
...
void
iinq_test_create_query_select_count_min_from_where_groupby_aggregate_schema(
	planck_unit_test_t *tc
) {
	DEFINE_SCHEMA(test, {
		int x;
	...
	MATERIALIZED_QUERY(SELECT(SELECT_AGGR(0), SELECT_AGGR(1)), AGGREGATES(COUNT(test_tuple->y), MIN(test_tuple->x)), FROM(1, test), WHERE(1), GROUPBY(ASCENDING_INT(NEUTRALIZE(test.key, uint32_t))), HAVING_ALL, ORDERBY_NONE, , , &processor);
...
void
iinq_test_create_query_select_all_from_where_orderby_ascending_string_records(
	planck_unit_test_t	*tc,
	ion_iinq_result_t	*result,
	uint32_t			count,
	uint32_t			total
	...
	char *key			= (char *) result->processed;
/*	ion_value_t value	= result->processed + sizeof(uint32_t); */

	char *expected_key	= "test";

	printf("key:%s", key);
	PLANCK_UNIT_ASSERT_TRUE(tc, expected_key == key);
/*	PLANCK_UNIT_ASSERT_INT_ARE_EQUAL(tc, expected_key, NEUTRALIZE(value, uint32_t)); */
}

void
iinq_test_orderby_string_ascending(
	ion_iinq_query_processor_t *processor
) {
/*	MATERIALIZED_QUERY(SELECT(test.key), AGGREGATES_NONE, FROM(0, test), WHERE(1), GROUPBY_NONE, HAVING_NONE, ORDERBY(ASCENDING(test.key)), , , processor); */
	MATERIALIZED_QUERY(SELECT(SELECT_EXPR(NEUTRALIZE(test.key, uint32_t))), AGGREGATES_NONE, FROM(0, test), WHERE(1), GROUPBY_NONE, HAVING_NONE, ORDERBY(ASCENDING(test.key)), , , processor);
}

void
iinq_test_create_query_select_all_from_where_orderby_string(
	planck_unit_test_t	*tc,
	uint32_t			num_records,
	ion_boolean_e		ascending
) {
	...
	if (boolean_true == ascending) {
		state.func = iinq_test_create_query_select_all_from_where_orderby_ascending_string_records;
	}
	else {
		state.func = iinq_test_create_query_select_all_from_where_orderby_descending_records;
	}
	...
	if (boolean_true == ascending) {
		iinq_test_orderby_string_ascending(&processor);
	}
	else {
		iinq_test_orderby_general_descending(&processor);
	}
...
void
iinq_test_create_query_select_all_from_where_orderby_string_ascending_small(
	planck_unit_test_t *tc
) {
	iinq_test_create_query_select_all_from_where_orderby_string(tc, 2, boolean_true);
}

void
iinq_test_create_query_select_all_from_where_orderby_string_ascending_large(
	planck_unit_test_t *tc
) {
...
/*	PLANCK_UNIT_ADD_TO_SUITE(suite, iinq_test_create_query_select_min_from_where_orderby_ascending_small); */
/*	PLANCK_UNIT_ADD_TO_SUITE(suite, iinq_test_create_query_select_min_from_where_orderby_descending_small); */
/*	PLANCK_UNIT_ADD_TO_SUITE(suite, iinq_test_create_query_select_min_from_where_orderby_ascending_large); */
/*	PLANCK_UNIT_ADD_TO_SUITE(suite, iinq_test_create_query_select_min_from_where_orderby_descending_large); */
...
/*	PLANCK_UNIT_ADD_TO_SUITE(suite, iinq_test_create_query_select_count_min_from_where_groupby_orderby_aggregate_descending_schema); */
	...
	PLANCK_UNIT_ADD_TO_SUITE(suite, iinq_test_create_query_select_all_from_where_orderby_string_ascending_small);
